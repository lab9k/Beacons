...
public class Verdiep1Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_verdiep1, container, false);

        hoofdActivity = ((MainActivity) getActivity());

        lijst = v.findViewById(R.id.recycler_view_1);
        ...
        adapter = new BeaconAdapter(hoofdActivity.getBestaande1Beacons());
