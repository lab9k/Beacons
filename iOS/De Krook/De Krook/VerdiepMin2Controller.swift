...
class VerdiepMin2Controller: UITableViewController, CLLocationManagerDelegate  {
    ...
    private func fillBeacons() {
        ...
        let hex = String(237, radix: 16)
        beacons.append(Beacon(name: "\(237)", region: CLBeaconRegion(proximityUUID: UUID(uuidString: "e2c56db5-dffb-48d2-b060-d04f435441\(hex)")!, identifier: "\(237)")));
    }
